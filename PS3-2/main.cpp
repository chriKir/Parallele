...
//            for (int iterations = 100; iterations < 101; iterations *= 10) {
                ...
                cl_mem buffer_u1 = loader->AddBuffer(CL_MEM_READ_ONLY, 1, matrix_size * matrix_size * sizeof(cl_float));
                cl_mem buffer_u2 = loader->AddBuffer(CL_MEM_READ_ONLY, 2, matrix_size * matrix_size * sizeof(cl_float));

                loader->WriteBuffer(buffer_f, f, 0, matrix_size * matrix_size * sizeof(cl_float));
                loader->WriteBuffer(buffer_u1, u1, 1, matrix_size * matrix_size * sizeof(cl_float));
                loader->WriteBuffer(buffer_u2, u2, 2, matrix_size * matrix_size * sizeof(cl_float));
                ...
                for (int i = 0; i < iterations; i++) {
                    ...
                    loader->setKernelArg(b_u1, 1, sizeof(cl_mem));
                    loader->setKernelArg(b_u2, 2, sizeof(cl_mem));
                }
